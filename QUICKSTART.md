...
Это поставит зависимости, соберёт надёжный детектор камеры (CoreMediaIO),
найдёт лампы в сети, настроит автозапуск через launchd и поднимет
HomeKit-мост для Home App (код пары: **031-45-154**). Подробности в
[README.md](README.md).
